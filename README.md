...
```bash
curl -fsSL https://github.com/gukak/GoogleTakeOutBack/releases/latest/download/install.sh | bash
```
...
```powershell
irm https://github.com/gukak/GoogleTakeOutBack/releases/latest/download/install.ps1 | iex
```
