...
```bash
curl -fsSL https://github.com/gukak/GoogleTakeOutBack/releases/download/v0.4.6/install.sh | bash
```
...
```powershell
irm https://github.com/gukak/GoogleTakeOutBack/releases/download/v0.4.6/install.ps1 | iex
```
