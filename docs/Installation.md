...
```bash
curl -fsSL https://github.com/OWNER/REPO/releases/download/v0.4.9/install.sh | bash
```
...
curl -fsSL https://github.com/OWNER/REPO/releases/download/v0.4.9/install.sh | bash -s -- --force

# Install a specific version
TAKEOUTBACK_VERSION=v0.4.9 curl -fsSL https://github.com/OWNER/REPO/releases/download/v0.4.9/install.sh | bash

# Do not download the Windows binary
TAKEOUTBACK_FETCH_BOTH=0 curl -fsSL https://github.com/OWNER/REPO/releases/download/v0.4.9/install.sh | bash
```
...
```powershell
# Force install into a non-empty directory
irm https://github.com/OWNER/REPO/releases/download/v0.4.9/install.ps1 | iex -- -Force

# Install a specific version
$env:TAKEOUTBACK_VERSION = "v0.4.9"
irm https://github.com/OWNER/REPO/releases/download/v0.4.9/install.ps1 | iex

# Do not download the Linux binary
irm https://github.com/OWNER/REPO/releases/download/v0.4.9/install.ps1 | iex -- -NoBoth
```
