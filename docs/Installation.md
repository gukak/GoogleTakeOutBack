...
curl -fsSL https://github.com/OWNER/REPO/releases/latest/download/install.sh | bash -s -- --force

# Install a specific version
TAKEOUTBACK_VERSION=v0.6.2 curl -fsSL https://github.com/OWNER/REPO/releases/download/v0.6.2/install.sh | bash

# Do not download the Windows binary
TAKEOUTBACK_FETCH_BOTH=0 curl -fsSL https://github.com/OWNER/REPO/releases/latest/download/install.sh | bash
```
...
```powershell
# Force install into a non-empty directory
irm https://github.com/OWNER/REPO/releases/latest/download/install.ps1 | iex -- -Force

# Install a specific version
$env:TAKEOUTBACK_VERSION = "v0.6.2"
irm https://github.com/OWNER/REPO/releases/download/v0.6.2/install.ps1 | iex

# Do not download the Linux binary
irm https://github.com/OWNER/REPO/releases/latest/download/install.ps1 | iex -- -NoBoth
```
